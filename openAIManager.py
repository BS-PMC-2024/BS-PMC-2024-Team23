...
def accpected_result(program:str,time:str ,weight:int,high:int,name:str,gender:str):
    ...
    prompt=(f"give me the expected result for this program {program} if the user will follow this program for {time}"
            ...
            f"write excacly how much in kg the trainee should loose if the keep follow this program."
            f"dont write the program. just the expcted result."
            f"dont write that as an AI you dont have the ability to know how many he will lose. just write the result you can expect"
